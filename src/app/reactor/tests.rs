...
fn stale_user_space_appearance_is_ignored_when_authoritative_window_space_differs() {
    let (mut reactor, wid, wsid, space1, space2, _frame) = reactor_with_window_moved_to_space2();
    crate::windows::platform::window_server::set_window_spaces_override(wsid, Some(vec![space2.get()]));
...
fn same_app_focus_change_hides_mouse_and_window_server_confirmation_reasserts_it() {
    ...
    assert!(matches!(request, crate::input::platform::input_tap::Request::HideOnFocus));
...
fn topology_window_delta_reassigns_missing_window_to_inactive_space() {
    ...
    reactor.handle_event(space_state_event_with(
        ...
        |state| {
            state.has_seen_display_set = true;
            state.topology_window_delta = Some(crate::displays::domain::topology::TopologyWindowDelta {
                epoch: 11,
    ...
    crate::windows::platform::window_server::set_window_spaces_override(moved_wsid, None);
    crate::windows::platform::window_server::set_space_window_list_for_space_override(active_space.get(), None);
...
fn topology_window_delta_is_not_ignored_by_command_space_only_short_circuit() {
    ...
    crate::windows::platform::window_server::set_window_spaces_override(wsid, Some(vec![space2.get()]));
    crate::windows::platform::window_server::set_space_window_list_for_space_override(space1.get(), Some(vec![]));
    crate::windows::platform::window_server::set_space_window_list_for_space_override(
        space2.get(),
    ...
    crate::windows::platform::window_server::set_window_spaces_override(wsid, None);
    crate::windows::platform::window_server::set_space_window_list_for_space_override(space1.get(), None);
    crate::windows::platform::window_server::set_space_window_list_for_space_override(space2.get(), None);
...
fn display_churn_quarantines_window_frame_and_membership_events() {
    ...
    let _ = crate::displays::platform::display_churn::begin(rini_skylight_sys::DisplayReconfigFlags::ADD);
...
fn genuine_close_during_sleep_recovery_does_not_leave_layout_ghost() {
    ...
    crate::windows::platform::window_server::set_window_ordered_in_override(closed_wsid, Some(false));
    reactor.handle_event(Event::SpaceStateChanged(recovered));
...
fn authoritative_active_space_membership_comes_from_space_window_ids_directly() {
    ...
    crate::windows::platform::window_server::set_space_window_list_for_connection_override(Some(vec![
        wsid_a.as_u32(),
        wsid_b.as_u32(),
    ]));
...
fn authoritative_active_space_membership_queries_each_active_space_independently() {
    ...
    crate::windows::platform::window_server::set_window_spaces_override(wsid_left, Some(vec![space1.get()]));
    crate::windows::platform::window_server::set_window_spaces_override(wsid_right, Some(vec![space2.get()]));
...
fn a_parked_window_is_not_claimed_by_the_display_it_is_parked_over() {
    ...
    crate::windows::platform::window_server::set_window_spaces_override(wsid, Some(vec![builtin_space.get()]));
...
mod strip_regroup {
    ...
    fn a_focus_response_onto_the_strip_raises_the_on_screen_strip_over_the_floating_window() {
        ...
        crate::windows::platform::window_server::set_front_to_back_override(Some(vec![902, 904, 901, 903]));
    ...
    fn a_grouped_order_is_left_alone_by_the_focus_response() {
        let (mut reactor, mut raise_rx, _space) = reactor_with_sandwich();
        crate::windows::platform::window_server::set_front_to_back_override(Some(vec![902, 901, 903, 904]));
        reactor.handle_layout_response(
            layout::EventResponse {
                changed: true,
                raise_windows: vec![WindowId::new(1, 1)],
    ...
    fn same_app_keyboard_navigation_regroups_the_strip() {
        ...
        crate::windows::platform::window_server::set_front_to_back_override(Some(vec![901, 904, 902, 903]));
    ...
    fn a_column_scrolled_in_behind_the_floating_window_is_lifted_after_the_layout() {
        ...
        crate::windows::platform::window_server::set_front_to_back_override(Some(vec![902, 901, 904, 903]));
    ...
    fn focus_on_a_window_outside_the_layout_does_not_regroup_the_strip() {
        ...
        crate::windows::platform::window_server::set_front_to_back_override(Some(vec![905, 904, 901, 902, 903]));
