...
use crate::animation::domain::motion::fit::{fits_frame, is_a_resize, outgrows};
...
pub enum ContentMode {
    ...
    /// overlay" in `docs/animation/animation-smoothness.md`.
    Crop,
}
...
/// in `docs/animation/animation-smoothness.md`).
...
/// place" in `docs/animation/animation-smoothness.md`.
