...
//! without an image. Measurements behind the tolerances are in `docs/animation/capture-overlay-research.md`.
...
/// engine" in `docs/animation/capture-overlay-research.md`.
...
/// keep. See "The wallpaper is not reliably a window" in `docs/animation/capture-overlay-research.md`.
