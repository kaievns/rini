...
pub fn resolve_start(
    ...
    // the park threshold, and the server may already report the slot. See docs/animation/animation-smoothness.md.
...
pub fn worth_animating(from: CGRect, to: CGRect, display: CGRect) -> bool {
    ...
    (0..SAMPLES).any(|step| {
        ...
        let at = crate::animation::domain::motion::tile::lerp_rect(from, to, t);
