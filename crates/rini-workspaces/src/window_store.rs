...
//! (`rini_windows::catalogue`) together with each window's workspace assignment. Catalogue reads
...
pub use crate::assignment::{WindowWorkspaceInfo, WorkspaceAssignments};
